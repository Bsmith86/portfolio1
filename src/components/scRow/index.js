...
const ScreenshotsRow = () => {
    return (
        <div className="screenshots-row">
          <a href='https://moviehunt.onrender.com'><Screenshot imageUrl={movie} alt="Screenshot 1" description="Movie Hunt: Using the IMDB api, this app allows users to sech the database and receive all pertinent information for the searched movie and add it to a favorites list for later.  " /></a>
